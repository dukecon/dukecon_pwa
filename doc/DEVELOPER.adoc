...
To use a static JSON file with conference data of 2017, just uncomment in
Conference.js:
...
javaland2017.json (under /static/rest/conferences/) is linked to. Please ignore
...
To update package to the next version, please run the following commands:
